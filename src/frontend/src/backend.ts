...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: number, arg3: string, arg4: string, arg5: boolean): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: bigint, arg7: string, arg8: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: string, arg5: string, arg6: boolean): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateSettings(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSettings(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
